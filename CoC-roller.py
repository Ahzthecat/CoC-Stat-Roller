...
##converted from python 2.x to 3.x using 2to3
...
def generator():
    ...
    input("Press enter to derive the secondary attributes\n\n")
...
def main():
    ...
    job=input("What occupation have you chosen?")
    go=input("Shall we begin? (y/n)")
    while go.upper()=="Y":
        generator()
...
investigator=input('What is your investigator\'s name?\n')
main()
print("\n\nWould you like to generate another character?")
newchar=input("Generate? (Y/N):")
while newchar.upper()=="Y":
    investigator=input('What is this investigator\'s name?\n')
    again()
...
input("Press enter to venture forth into the darkness.")
